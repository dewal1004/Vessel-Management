pageextension 50224 pageextension50224 extends "Purchase Order"
{
    // layout
    // {
    //     modify("No.")
    ...
    //     //Unsupported feature: Property Modification (ControlType) on ""Pay-to City"(Control 30)".


    //     //Unsupported feature: Property Modification (Name) on ""Pay-to City"(Control 30)".


    //     //Unsupported feature: Property Insertion (InstructionalTextML) on ""Pay-to City"(Control 30)".
    ...
    //     //Unsupported feature: Property Deletion (ApplicationArea) on ""Pay-to City"(Control 30)".
    ...
    var
        ...
        //Unsupported feature: Property Modification (Id) on "CanCancelApprovalForRecord(Variable 1015)".

        //var
        //>>>> ORIGINAL VALUE:
        //CanCancelApprovalForRecord : 1015;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //CanCancelApprovalForRecord : 10015;
        //Variable type has not been exported.


        //Unsupported feature: Property Modification (Id) on "DocumentIsPosted(Variable 1016)".

        //var
        //>>>> ORIGINAL VALUE:
        //DocumentIsPosted : 1016;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //DocumentIsPosted : 10016;
        //Variable type has not been exported.
